...
export default function AboutInnopolis() {
    return <>
        ...
        <ImageText src={'/Portfolio/img/universitet-innopolis.jpeg'}>Innopolis University is a Russian autonomous non—profit organization of higher education in the city of Innopolis (Verkhneuslonsky district, Republic of Tatarstan) specializing in education, research and development in the field of information technology and robotics.
