...
export default function AboutInnopolis() {
    return <>
        ...
        <ImageText src={'https://www.innopolis.com/uploads/thumbs/universitet-innopolis-3e9c6a61e7-1a9f4e6652b3a80977c0e9190611e142.jpeg'}>Innopolis University is a Russian autonomous non—profit organization of higher education in the city of Innopolis (Verkhneuslonsky district, Republic of Tatarstan) specializing in education, research and development in the field of information technology and robotics.
